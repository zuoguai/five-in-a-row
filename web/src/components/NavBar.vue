<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
      ...
      <router-link class="navbar-brand" :to="{ name: 'pk_index' }">FIR</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            ...
            <router-link :class="route_name == 'pk_index' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'pk_index' }">对战(pk)</router-link>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav" v-if="$store.state.user.is_login">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><router-link :class="route_name == 'user_index' ? 'nav-link active' : 'nav-link'"
                  :to="{ name: 'user_index' }">个人中心</router-link></li>
              <li>
        ...
        <ul class="navbar-nav" v-else-if="!$store.state.user.is_logining">
          <li class="nav-item ">
